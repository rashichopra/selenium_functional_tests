 ...
 *
 */
public class CustomizedReporter extends HTMLReporter{

	private static final String OUT_FOLDER = "target/custom-test-report";
	...
	public void generateReport(List<XmlSuite> arg0, List<ISuite> suites,
    	...
    	for ( ISuite suite : suites ) {
    		...
    		logFileName = suiteName+"_"+timeStamp+".html";  
    		}
      ...
      //  System.setProperty("logfilename", logFileName);
		...
		try{
			m_out = createWriter(outdir, logFileName);
	...
	/*private PrintWriter createWriter(String outdir, String outfile) throws IOException
	{
	//new File(outdir).mkdirs();
	return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, outfile))));
	}
